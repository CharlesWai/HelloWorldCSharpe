...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"bdb270ad-9555-40c3-b839-2415d3976874\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [34 x i8] c"com.companyname.mauiappforandroid\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555258, ; android_runtime_jnienv_class_token
	i32 100672040, ; jnienv_initialize_method_token
	i32 100672039, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.17 = internal constant [32 x i8] c"libaot-MauiAppForAndroid.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [458 x %struct.DSOCacheEntry] [
	...
	; 16
	%struct.DSOCacheEntry {
		i64 642153014523883012, ; hash 0x8e962c3b2246e04, from name: aot-MauiAppForAndroid.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.17, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 17
	%struct.DSOCacheEntry {
	...
	; 67
	%struct.DSOCacheEntry {
		i64 2941893991511201884, ; hash 0x28d3b4ff9ae1985c, from name: MauiAppForAndroid.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.17, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 114
	%struct.DSOCacheEntry {
		i64 5160980473721878702, ; hash 0x479f7c6594eb78ae, from name: libaot-MauiAppForAndroid
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.17, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 130
	%struct.DSOCacheEntry {
		i64 6038562941826215622, ; hash 0x53cd49007d63aec6, from name: MauiAppForAndroid
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.17, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 250
	%struct.DSOCacheEntry {
		i64 10483552209485986726, ; hash 0x917d0f30b6ac7ba6, from name: aot-MauiAppForAndroid
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.17, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 254
	%struct.DSOCacheEntry {
		i64 10761014737029010749, ; hash 0x9556cde3975b953d, from name: libaot-MauiAppForAndroid.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.17, i32 0, i32 0), ; name
		i8* null; handle
	}, 
